...
public class CN7P<P1, P2, P3, P4, P5, P6, P7> implements ReturningNode<Void> {
    ...
    private final Consumers.C7<P1, P2, P3, P4, P5, P6, P7> executor;

    public CN7P(ParamInst<P1> param1, ParamInst<P2> param2, ParamInst<P3> param3, ParamInst<P4> param4, ParamInst<P5> param5, ParamInst<P6> param6, ParamInst<P7> param7, Consumers.C7<P1, P2, P3, P4, P5, P6, P7> executor) {
        this.param1 = param1;
        this.param2 = param2;
        this.param3 = param3;
        this.param4 = param4;
    ...
    public MethodInstance<Void> createInst(String methodId, List<MethodInstance<?>> params) {
        return new Instance(methodId,
                ...
                (MethodInstance<P7>) params.get(6)
        );
    }
    ...
    private class Instance extends MethodInstance<Void> {
        ...
        protected Instance(String id, MethodInstance<P1> param1, MethodInstance<P2> param2, MethodInstance<P3> param3, MethodInstance<P4> param4, MethodInstance<P5> param5, MethodInstance<P6> param6, MethodInstance<P7> param7) {
            super(id);
            this.param1 = param1;
            this.param2 = param2;
            this.param3 = param3;
        ...
        public Void call(VarMap origin, MethodPipeline<?> pipeline) {
            executor.apply(param1.call(origin, pipeline), param2.call(origin, pipeline),
                    ...
                    param5.call(origin, pipeline), param6.call(origin, pipeline), param7.call(origin, pipeline));
        ...
        protected void saveAdditional(JsonObject object) {
            object.add(CN7P.this.param1.name(), param1.toJson());
            object.add(CN7P.this.param2.name(), param2.toJson());
            object.add(CN7P.this.param3.name(), param3.toJson());
            object.add(CN7P.this.param4.name(), param4.toJson());
            object.add(CN7P.this.param5.name(), param5.toJson());
            object.add(CN7P.this.param6.name(), param6.toJson());
            object.add(CN7P.this.param7.name(), param7.toJson());
        }
    }
}
