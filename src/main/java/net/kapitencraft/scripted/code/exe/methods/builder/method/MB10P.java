...
public class MB10P<R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> implements ReturningInst<P1, R> {
    ...
    public MB10P(VarType<R> retType, ParamInst<P1> param1, ParamInst<P2> param2, ParamInst<P3> param3, ParamInst<P4> param4, ParamInst<P5> param5, ParamInst<P6> param6, ParamInst<P7> param7, ParamInst<P8> param8, ParamInst<P9> param9, ParamInst<P10> param10) {
