...
public class MN3P<R, P1, P2, P3> implements ReturningNode<R> {
    ...
    public MethodInstance<R> createInst(List<MethodInstance<?>> params) {
        return create((MethodInstance<P1>) params.get(0), (MethodInstance<P2>) params.get(1), (MethodInstance<P3>) params.get(2));
    }

    public MethodInstance<R> create(MethodInstance<P1> param1Inst, MethodInstance<P2> param2Inst, MethodInstance<P3> param3Inst) {
        return new Instance(param1Inst, param2Inst, param3Inst);
    }
    ...
    private class Instance extends MethodInstance<R> {
        ...
        private Instance(MethodInstance<P1> param1, MethodInstance<P2> param2, MethodInstance<P3> param3) {
            this.param1 = param1;
            this.param2 = param2;
            this.param3 = param3;
        }
