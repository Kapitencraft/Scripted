...
public class CN8P<P1, P2, P3, P4, P5, P6, P7, P8> implements ReturningNode<Void> {
    ...
    private final Consumers.C8<P1, P2, P3, P4, P5, P6, P7, P8> executor;

    public CN8P(ParamInst<P1> param1, ParamInst<P2> param2, ParamInst<P3> param3, ParamInst<P4> param4, ParamInst<P5> param5, ParamInst<P6> param6, ParamInst<P7> param7, ParamInst<P8> param8, Consumers.C8<P1, P2, P3, P4, P5, P6, P7, P8> executor) {
        this.param1 = param1;
        this.param2 = param2;
        this.param3 = param3;
        this.param4 = param4;
    ...
    private class Instance extends MethodInstance<Void> {
        ...
        protected Instance(String id, MethodInstance<P1> param1, MethodInstance<P2> param2, MethodInstance<P3> param3, MethodInstance<P4> param4, MethodInstance<P5> param5, MethodInstance<P6> param6, MethodInstance<P7> param7, MethodInstance<P8> param8) {
            super(id);
            this.param1 = param1;
            this.param2 = param2;
            this.param3 = param3;
        ...
        protected void saveAdditional(JsonObject object) {
            object.add(CN8P.this.param1.name(), param1.toJson());
            object.add(CN8P.this.param2.name(), param2.toJson());
            object.add(CN8P.this.param3.name(), param3.toJson());
            object.add(CN8P.this.param4.name(), param4.toJson());
            object.add(CN8P.this.param5.name(), param5.toJson());
            object.add(CN8P.this.param6.name(), param6.toJson());
            object.add(CN8P.this.param7.name(), param7.toJson());
            object.add(CN8P.this.param8.name(), param8.toJson());
        }
    }
}
