...
public class MN7P<R, P1, P2, P3, P4, P5, P6, P7> implements ReturningNode<R> {
    ...
    private final @Nullable Functions.F7<P1, P2, P3, P4, P5, P6, P7, R> executor;

    public MN7P(VarType<R> retType, ParamInst<P1> param1, ParamInst<P2> param2, ParamInst<P3> param3, ParamInst<P4> param4, ParamInst<P5> param5, ParamInst<P6> param6, ParamInst<P7> param7, @Nullable Functions.F7<P1, P2, P3, P4, P5, P6, P7, R> executor) {
    ...
    public MethodInstance<R> createInst(String id, List<MethodInstance<?>> params) {
        return create(id, (MethodInstance<P1>) params.get(0), (MethodInstance<P2>) params.get(1),
                ...
                (MethodInstance<P5>) params.get(4), (MethodInstance<P6>) params.get(5), (MethodInstance<P7>) params.get(6));
    }
    ...
    public MethodInstance<R> create(String id, MethodInstance<P1> param1Inst, MethodInstance<P2> param2Inst,
                                    ...
                                    MethodInstance<P5> param5Inst, MethodInstance<P6> param6Inst, MethodInstance<P7> param7Inst) {
        return new Instance(id, param1Inst, param2Inst, param3Inst, param4Inst, param5Inst, param6Inst, param7Inst);
    }
    ...
    private class Instance extends MethodInstance<R> {
        ...
        private Instance(String id, MethodInstance<P1> param1, MethodInstance<P2> param2, MethodInstance<P3> param3, MethodInstance<P4> param4, MethodInstance<P5> param5, MethodInstance<P6> param6, MethodInstance<P7> param7) {
            super(id);
            this.param1 = param1;
            this.param2 = param2;
            this.param3 = param3;
        ...
        protected void saveAdditional(JsonObject object) {
            object.add(MN7P.this.param1.name(), param1.toJson());
            object.add(MN7P.this.param2.name(), param2.toJson());
            object.add(MN7P.this.param3.name(), param3.toJson());
            object.add(MN7P.this.param4.name(), param4.toJson());
            object.add(MN7P.this.param5.name(), param5.toJson());
            object.add(MN7P.this.param6.name(), param6.toJson());
            object.add(MN7P.this.param7.name(), param7.toJson());
        }
