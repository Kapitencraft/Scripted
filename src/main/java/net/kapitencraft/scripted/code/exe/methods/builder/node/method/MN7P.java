...
public class MN7P<R, P1, P2, P3, P4, P5, P6, P7> implements ReturningNode<R> {
    ...
    public MethodInstance<R> create(MethodInstance<P1> param1Inst, MethodInstance<P2> param2Inst,
        ...
        return new Instance(param1Inst, param2Inst, param3Inst, param4Inst, param5Inst, param6Inst, param7Inst);
    }
    ...
    private class Instance extends MethodInstance<R> {
        ...
        private Instance(MethodInstance<P1> param1, MethodInstance<P2> param2, MethodInstance<P3> param3, MethodInstance<P4> param4, MethodInstance<P5> param5, MethodInstance<P6> param6, MethodInstance<P7> param7) {
            this.param1 = param1;
            this.param2 = param2;
            this.param3 = param3;
            this.param4 = param4;
