...
public class ForLoopFunction extends Function {
    ...
    public class Instance<T> extends Function.Instance {
        ...
        public Instance(Function.Instance onInit, Method<Boolean>.Instance condition, Function.Instance onLoop, MethodPipeline<T> body) {
            this.onInit = onInit;
        ...
        public void execute(VarMap map, MethodPipeline<?> source) {
            ...
            for (onInit.execute(map, source); condition.callInit(map).getValue(); onLoop.execute(map, source)) {
