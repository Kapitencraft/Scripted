...
public class CN6P<P1, P2, P3, P4, P5, P6> implements ReturningNode<Void> {
    ...
    private final Consumers.C6<P1, P2, P3, P4, P5, P6> executor;

    public CN6P(ParamInst<P1> param1, ParamInst<P2> param2, ParamInst<P3> param3, ParamInst<P4> param4, ParamInst<P5> param5, ParamInst<P6> param6, Consumers.C6<P1, P2, P3, P4, P5, P6> executor) {
        this.param1 = param1;
        this.param2 = param2;
        this.param3 = param3;
        this.param4 = param4;
    ...
    private class Instance extends MethodInstance<Void> {
        ...
        protected Instance(String id, MethodInstance<P1> param1, MethodInstance<P2> param2, MethodInstance<P3> param3, MethodInstance<P4> param4, MethodInstance<P5> param5, MethodInstance<P6> param6) {
            super(id);
            this.param1 = param1;
            this.param2 = param2;
            this.param3 = param3;
        ...
        protected void saveAdditional(JsonObject object) {
            object.add(CN6P.this.param1.name(), param1.toJson());
            object.add(CN6P.this.param2.name(), param2.toJson());
            object.add(CN6P.this.param3.name(), param3.toJson());
            object.add(CN6P.this.param4.name(), param4.toJson());
            object.add(CN6P.this.param5.name(), param5.toJson());
            object.add(CN6P.this.param6.name(), param6.toJson());
        }
    }
}
