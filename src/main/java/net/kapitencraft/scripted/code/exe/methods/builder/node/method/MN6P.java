...
public class MN6P<R, P1, P2, P3, P4, P5, P6> implements ReturningNode<R> {
    ...
    public MethodInstance<R> create(String id, MethodInstance<P1> param1Inst, MethodInstance<P2> param2Inst,
        ...
        return new Instance(id, param1Inst, param2Inst, param3Inst, param4Inst, param5Inst, param6Inst);
    }
    ...
    private class Instance extends MethodInstance<R> {
        ...
        private Instance(String id, MethodInstance<P1> param1, MethodInstance<P2> param2, MethodInstance<P3> param3, MethodInstance<P4> param4, MethodInstance<P5> param5, MethodInstance<P6> param6) {
            super(id);
            this.param1 = param1;
            this.param2 = param2;
            this.param3 = param3;
