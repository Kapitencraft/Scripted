...
import net.kapitencraft.scripted.util.MathHelper;
...
public interface Renderables {
    ...
    static void renderMethod(int color, int x, int y, GuiGraphics graphics, String text, boolean connect, VarType type) {
    ...
    static void setColor(GuiGraphics graphics, int color) {
        Vector4f rgb = MathHelper.getColor(color);
